...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EEE", "ECE", "CS", "IT", "ME", "OB & HR", "Economics", "Finance ", "Accounting", " ", " " }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            st.executeUpdate("insert into student(course,branch,rollNo,firstName,middleName,lastName,gender)values('"+course+"','"+branch+"','"+rollNo+"','"+firstName+"','"+middleName+"','"+lastName+"','"+gender+"')");
