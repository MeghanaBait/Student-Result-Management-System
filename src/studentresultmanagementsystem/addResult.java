...
public class addResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String ele = jTextField5.getText();
        String cNw = jTextField6.getText();
        ...
        try {
            ...
            if(rs.next()){
                st.executeUpdate("insert into result(rollNo,phy,chem,math,ele,cNw)values('"+rollNo+"','"+phy+"','"+chem+"','"+math+"','"+ele+"','"+cNw+"')");
                JOptionPane.showMessageDialog(null, "Successfully Updated");
                setVisible(false);
                new addResult().setVisible(true);
            }
            else{
                JOptionPane.showMessageDialog(null,"Roll number does not exist in our record");
                setVisible(false);
                new addResult().setVisible(true);
            }
        }
